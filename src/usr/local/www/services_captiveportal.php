...
))->setHelp('Clients will be disconnected after exceeding this amount of traffic, including both downloads and uploads. They may log in again immediately, though. ' .
...
))->setHelp('When enabled, clients will be disconnected after exceeding the amount of traffic retrieved from the RADIUS pfSense-Max-Total-Octets attribute.');
...
events.push(function() {
	...
	function hideRadius() {
		...
		hideCheckbox('radiustraffic_quota', hideAuth);
